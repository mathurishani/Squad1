...
const SquadHome = () => {
  ...
  return (
    <div className="p-6 mx-auto max-w-3xl bg-white shadow-md rounded-md">
      <h1 className="text-2xl font-bold text-gray-700 mb-4">Squad Member Details</h1>
      ...
      <h2 className="text-xl font-semibold text-gray-700 mt-8">Assigned College, Course, and Exam Details</h2>
      <div className="space-y-4">
